          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Masukan Data Calon Siswa</h3>
              </div>
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
                <div class="row">
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="asal_sekolah" id="asal_sekolah" autocomplete = 'off'>
                                </div>
                                <!-- /.input group -->
                        ...
                        <div class="form-group">
                            <label>Tanggal Lahir</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- <input type="text" class="form-control" name="tgl_lahir" id="tgl_lahir"> -->
                                    <input type="text" class="form-control" name="tgl_lahir" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask>
                                </div>
                                <!-- /.input group -->
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="tmpt_lahir" id="tmpt_lahir" autocomplete = 'off'>
                                    </div>
                                    <!-- /.input group -->
                        ...
                        <div class="form-group">
                            <label>Nama Ayah</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="father_name" id="father_name" autocomplete = 'off'>
                                </div>
                                <!-- /.input group -->
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="mother_name" id="mother_name" autocomplete = 'off'>
                                </div>
                                <!-- /.input group -->
                        ...
                        <div class="form-group">
                            <label>Alamat Orang Tua</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="alamat_ortu" id="alamat_ortu" autocomplete = 'off'>
                                </div>
                                <!-- /.input group -->
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="wali" id="wali" autocomplete = 'off'>
                                </div>
                                <!-- /.input group -->
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="alamat_wali" id="alamat_wali" autocomplete = 'off'>
                            </div>
                            <!-- /.input group -->
