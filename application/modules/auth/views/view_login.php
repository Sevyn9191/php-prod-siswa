...
<body class="hold-transition login-page java">
<div class="login-box">
  <div class="java-tree">
    <a href="#"><b>SISTEM PENERIMAAN SISWA BARU SMK SUMPAH PEMUDA</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php form_open('login');?>
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-12">
            <button type="submit" class="btn btn-danger btn-block" id="log-in">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
